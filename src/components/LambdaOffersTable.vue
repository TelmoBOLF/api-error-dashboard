<template>
  <div>
    <h2 class="text-xl font-semibold mb-4">Lambda Offers Errors</h2>
      ...
      <table class="min-w-full bg-white">
        <thead>
          <tr class="bg-gray-100 text-gray-700">
            ...
            <th class="py-2 px-4 text-left">Contact Email</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-2 px-4 border-t">{{ offer.contactEmail }}</td>
